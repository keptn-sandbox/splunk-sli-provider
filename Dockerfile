...
WORKDIR /src/splunk-sli-provider
...
RUN go build -ldflags '-linkmode=external' $BUILDFLAGS -v -o splunk-sli-provider
...
COPY --from=builder /src/splunk-sli-provider/splunk-sli-provider /splunk-sli-provider
